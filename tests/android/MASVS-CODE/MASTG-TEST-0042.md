...
Lastly, please note that for hybrid applications, one will have to check the JavaScript dependencies with RetireJS. Similarly for legacy Xamarin applications, one will have to check the C# dependencies.
