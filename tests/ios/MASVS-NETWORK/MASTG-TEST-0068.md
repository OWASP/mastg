...
As a quick smoke test, you can try to bypass certificate pinning using @MASTG-TECH-0064 as described in @MASTG-TECH-0064. Pinning related APIs being hooked by objection should appear in objection's output.
