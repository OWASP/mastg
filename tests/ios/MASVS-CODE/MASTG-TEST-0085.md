...
Next, note that for hybrid applications, you will have to check the JavaScript dependencies with RetireJS. For legacy .NET-based mobile applications, C# dependencies should be reviewed accordingly.
