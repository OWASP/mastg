...
Use the content-world variants of these APIs (introduced in iOS 14, see @MASTG-KNOW-0x01) to run DOM inspection code in an isolated world where the prototype chain cannot be tampered with by page JavaScript.
