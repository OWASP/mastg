...
Internally, the Play Integrity API uses the same cryptographic techniques as @MASTG-KNOW-0x01 to root its verdicts in hardware-backed trust. It is the recommended attestation provider for Android when using Firebase App Check (see @MASTG-KNOW-0x02).
