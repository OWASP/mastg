...
- Access to files outside the app's sandbox is mediated by the system and should be coordinated with [`NSFileCoordinator`](https://developer.apple.com/documentation/foundation/nsfilecoordinator).
...
- Access to external documents should be coordinated through [`NSFileCoordinator`](https://developer.apple.com/documentation/foundation/nsfilecoordinator).
