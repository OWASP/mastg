...
- **Execution context**: The logs include stack trace information that exposes internal symbols, function names, and code paths (e.g. `$s10MASTestApp9MastgTestC20handleRealisticErroryyFZ`).
