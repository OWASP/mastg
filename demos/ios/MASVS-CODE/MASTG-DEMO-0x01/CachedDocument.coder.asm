...
│           0x00005678      ldr x1, [x8, 0x3e0]                        ; [0x283e0:8]=0x1000000001a293 ; reloc.fixup.decodeObjectForKey: ; char *selector
...
│           0x00005698      ldr x8, [x8, 0x198]                        ; [0x24198:8]=0x8010000000000031 ; "1"
│           0x0000569c      blr x8
...
│      │    0x0000573c      ldr x8, [x8, 0x8b8]                        ; [0x248b8:8]=0x8010000000000115 ; reloc....ypN
│      │    0x00005740      add x2, x8, 8
│      │    0x00005744      adrp x3, segment.__DATA_CONST              ; 0x24000
│      │    0x00005748      ldr x3, [x3, 0x690]                        ; [0x24690:8]=0x80100000000000d0 ; reloc....SSN
│      │    0x0000574c      mov w8, 6
...
│   ╎╎│ │   0x00005854      ldr x1, [x8, 0x3e0]                        ; [0x283e0:8]=0x1000000001a293 ; reloc.fixup.decodeObjectForKey: ; char *selector
...
│   ╎╎│ │   0x00005874      ldr x8, [x8, 0x198]                        ; [0x24198:8]=0x8010000000000031 ; "1"
│   ╎╎│ │   0x00005878      blr x8
...
│      │    0x00005928      ldr x8, [x8, 0x8b8]                        ; [0x248b8:8]=0x8010000000000115 ; reloc....ypN
│      │    0x0000592c      add x2, x8, 8
│      │    0x00005930      adrp x3, segment.__DATA_CONST              ; 0x24000
│      │    0x00005934      ldr x3, [x3, 0x690]                        ; [0x24690:8]=0x80100000000000d0 ; reloc....SSN
│      │    0x00005938      mov w8, 6
...
│   ╎╎│ │   0x00005a40      ldr x8, [x8, 0x1a0]                        ; [0x241a0:8]=0x8010000000000032 ; "2"
│   ╎╎│ │   0x00005a44      blr x8
...
│   ╎╎│ │   0x00005a94      ldr x8, [x8, 0x198]                        ; [0x24198:8]=0x8010000000000031 ; "1"
│   ╎╎│ │   0x00005a98      blr x8
│   ╎╎│ │   0x00005a9c      ldur x0, [x29, -0x18]
│   ╎╎│ │   0x00005aa0      adrp x8, segment.__DATA_CONST              ; 0x24000
│   ╎╎│ │   0x00005aa4      ldr x8, [x8, 0x198]                        ; [0x24198:8]=0x8010000000000031 ; "1"
│   ╎╎│ │   0x00005aa8      blr x8
