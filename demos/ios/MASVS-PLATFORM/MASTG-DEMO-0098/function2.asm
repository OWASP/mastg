...
│      ╎│   0x100005140      mov x1, x0
│      ╎│   0x100005144      ldr x26, [x27, 0x10]
│      ╎│   0x100005148      mov x0, x22
│      ╎│   0x10000514c      mov x2, x21
│      ╎│   0x100005150      blr x26
│      ╎│   0x100005154      mov x0, x22                               ; int64_t arg1
│      ╎│   0x100005158      mov x1, 0                                 ; int64_t arg2
│      ╎│   0x10000515c      mov x2, -0x2000000000000000               ; int64_t arg3
│      ╎│   0x100005160      bl sym.func.100005278
│      ╎│   0x100005164      mov x24, x0
│      ╎│   0x100005168      mov x25, x1
│      ╎│   0x10000516c      ldr x27, [x27, 8]
│      ╎│   0x100005170      mov x0, x22
│      ╎│   0x100005174      mov x1, x21
│      ╎│   0x100005178      blr x27
│      ╎│   0x10000517c      mov x0, x24
│      ╎│   0x100005180      mov x1, x25
│      ╎│   0x100005184      blr x23
│      ╎│   0x100005188      mov x0, x25                               ; void *arg0
│      ╎│   0x10000518c      bl sym.imp.swift_bridgeObjectRelease      ; void swift_bridgeObjectRelease(void *arg0)
│      ╎│   0x100005190      adrp x8, segment.__DATA                   ; 0x100014000
│      ╎│   0x100005194      ldr x8, [x8, 0x2f8]
│      ╎│   0x100005198      cmn x8, 1
│     ┌───< 0x10000519c      b.ne 0x100005260
│     │╎│   ; CODE XREF from sym.func.1000050c0 @ 0x100005274(x)
│    ┌────> 0x1000051a0      adrp x1, segment.__DATA                   ; 0x100014000
│    ╎│╎│   0x1000051a4      add x1, x1, 0x300                         ; int64_t arg2
│    ╎│╎│   0x1000051a8      mov x0, x21                               ; int64_t arg1
│    ╎│╎│   0x1000051ac      bl sym.func.100007be4
...
│    ╎│     ; CODE XREF from sym.func.1000050c0 @ 0x10000519c(x)
