...
The output contains the `application:continue:restorationHandler:` selector, confirming that the compiled binary implements the Universal Link receiver method.

{{ output.txt }}

## Evaluation

The test fails because the `application:continue:restorationHandler:` selector is found inside the binary.
