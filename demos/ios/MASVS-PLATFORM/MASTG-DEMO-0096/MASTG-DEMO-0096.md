...
The `ai-decompiled.swift` file was generated by ChatGPT 5.4 after giving it the original `showWebView.asm` and additional code that it requested to understand the context. The decompiled code is not exact and may contain inaccuracies, but it provides a more readable representation of the relevant logic.
...
0x100004f18      mov x2, x26           ; fileURL (NSURL)
