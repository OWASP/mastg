...
| egrep 'json\.NSAppTransportSecurity\.NSExceptionDomains\["[^"]+"\]\.(NSExceptionMinimumTLSVersion|NSTemporaryExceptionMinimumTLSVersion|NSExceptionRequiresForwardSecrecy)' \
> output.txt
