...
You can use this attacker app to demonstrate the vulnerability shown in @MASTG-DEMO-0x01: install and run it while the victim app is in the foreground, then activate the overlay. This lets you verify whether the unprotected button in the victim app accepts touch events through the overlay.
