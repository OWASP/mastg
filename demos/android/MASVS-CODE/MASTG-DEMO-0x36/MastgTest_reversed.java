...
public final class MastgTest {
    ...
    private final void startUpdateFlow(AppUpdateInfo appUpdateInfo, ActivityResultLauncher<IntentSenderRequest> appUpdateResultLauncher) {
        try {
            this.appUpdateManager.startUpdateFlowForResult(appUpdateInfo, appUpdateResultLauncher, AppUpdateOptions.newBuilder(1).build());
        } catch (Exception e) {
            Log.e("MastgTest", "Failed to start update flow.", e);
            Function1<? super UpdateState, Unit> function1 = this.onUpdateStateChanged;
            if (function1 != null) {
